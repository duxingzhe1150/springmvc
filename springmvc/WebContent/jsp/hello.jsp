...
<body>
		...
		<form action="<%=request.getContextPath() %>/mvc/login">
			<table>
				...
				<tr>
					<td>密码：</td>
					<td><input type="password" name="psw" id="v_psw" />
						<input type="hidden" name="password" id="v_password" value="0"/>
					</td>
				</tr>
				<tr>
    ...
    new SMValidator('form', {
        ...
        submit: function(valid, form) {
        	...
        	var psw=document.getElementById("v_psw").value;
        	var usn=document.getElementById("username").value;
        	
        	var password=hex_md5(hex_md5(usn+hex_md5(psw))+"${salt}");
        	
        	document.getElementById("v_psw").value="";
        	
        	document.getElementById("v_password").value=password;
